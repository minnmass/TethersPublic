...
namespace KlimeAndPsycho.PowerCables
{
    ...
    public class PowerCable : MyGameLogicComponent
    {
        ...
        public const int SETTINGS_CHANGED_COUNTDOWN = (60 * 1);
        int syncCountdown;
        ...
        public override void UpdateOnceBeforeFrame()
        {
            try
            {
                ...
                */
                ...
                {
                    ConnectedBlock = (IMyTerminalBlock)MyAPIGateway.Entities.GetEntityById(Settings.ConnectedBlockId);
            ...
            cable_hose = MyStringId.GetOrCompute("ConveyorHose");
                ...
                if (STATE == 1)
                {
                    ...
                    if (hitblock != null && hitblock.hit_block != null)
                    {
                        ...
                        if (distance <= InteractionDistance * InteractionDistance)
                        {
                            if (hitblock.hit_block != block.SlimBlock)
                            {
                                ...
                                if (endBlock == null || endBlock.CubeGrid == block.CubeGrid || block.IsInSameLogicalGroupAs(endBlock))
                                {
                                    ...
                                    cable_vis_Red, ref colRed, line_thickness, BlendTypeEnum.PostPP);
                                }
                                else
                                {
                                    MySimpleObjectDraw.DrawLine(startAttach, hitblock.hit_location,
                                    cable_vis_Green, ref colGreen, line_thickness, BlendTypeEnum.PostPP);
                                }
                            }
                            else
                            {
                        ...
                        else
                        {
                            ...
                            cable_vis, ref col, hand_line_thickness, BlendTypeEnum.PostPP);
                        }
                    }
                    else
                    {
